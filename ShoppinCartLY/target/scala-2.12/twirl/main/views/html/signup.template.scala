...
<form id="sig">
  <div class="container">
      ...
      onclick="window.location.href = '"""),_display_(/*100.41*/controllers/*100.52*/.security.routes.LoginCtrl.signup()),format.raw/*100.87*/("""';">
      </div>
