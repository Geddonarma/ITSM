...
"""),_display_(/*9.2*/main("View Order history", customer)/*9.38*/ {_display_(Seq[Any](format.raw/*9.40*/("""
	...
	"""),format.raw/*12.2*/("""<div class="col-md-12">
        ...
        <p class="text-center">
         ...
         """)))}),format.raw/*67.11*/("""<!-- End of For loop -->
       
        </div>
        <div class="col-md-15">
            <p class="text-center">
                <a href=""""),_display_(/*72.27*/routes/*72.33*/.ProductCtrl.listProducts(0)),format.raw/*72.61*/("""" class="btn btn-primary">
                <span class="glyphicon glyphicon-hand-left"></span> Continue Shopping</a>
            </p>
        </div> 
        <div class="col-md-15">
            <p class="text-center">
                <a href=""""),_display_(/*78.27*/routes/*78.33*/.ShoppingCtrl.showBasket),format.raw/*78.57*/("""" class="btn btn-primary">
