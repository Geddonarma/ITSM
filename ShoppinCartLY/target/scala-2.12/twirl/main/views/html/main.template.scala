...
<body>
            ...
            -->
                ...
                <li class="dropdown">
                    <a href="javascript:void(0)" class="dropbtn">Dropdown Menu</a>                        <div class="dropdown-content">
                          <a href=""""),_display_(/*122.37*/routes/*122.43*/.ProductCtrl.listProducts(0)),format.raw/*122.71*/("""">Search for Products</a>
                          <a href=""""),_display_(/*123.37*/routes/*123.43*/.ProductCtrl.about),format.raw/*123.61*/("""">About Us</a>
                          <a href=""""),_display_(/*124.37*/routes/*124.43*/.ProductCtrl.contact),format.raw/*124.63*/("""">Contact Us</a>
    ...
    <container>
        <row>
            <div class="col-md-12">
                """),_display_(/*137.18*/content),format.raw/*137.25*/("""
...
<br>
    ...
    <script src=""""),_display_(/*154.19*/routes/*154.25*/.Assets.versioned("javascripts/main.js")),format.raw/*154.65*/(""""></script>
</body>
